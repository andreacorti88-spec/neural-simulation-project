...
tau_rate_hat = 500*ms  # finestra della stima di tasso di scarica per neurone
...
target_rate = 3*Hz
fattore_min, fattore_max = 0.97, 1.03
...
tight_layout()
savefig('dialogo_spiking_bidirezionale_omeostasi.png', dpi=150)
print("\nGrafico salvato in dialogo_spiking_bidirezionale_omeostasi.png")
