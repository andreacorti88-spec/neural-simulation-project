"""
Confine del recupero visto nella sezione 5.29: quel test spegneva 10
neuroni scelti per dose fisica (CNAO), di cui solo alcuni (4 nel caso
piu' severo) dentro la zona di codifica del messaggio x=0.65. Qui si
spinge deliberatamente oltre il dato fisico, come test di confine
puro: spenti TUTTI E 11 i neuroni della zona di codifica di x=0.65
(l'intero gruppo_stim), una lesione completa della regione che
codifica quel messaggio -- non piu' uno scenario di dose CNAO
specifico, ma la domanda "esiste un punto oltre il quale la
plasticita' residua non basta piu' a compensare?".

Stesso protocollo della sezione 5.29: training esteso 5x (300
ripetizioni), traiettoria di recupero valutata in 15 finestre lungo
tutto il training.
"""
...
# piu' i 10 a dose piu' alta di uno scenario CNAO -- un test di
# confine, non un dato fisico) -- il danno piu' severo possibile per
# QUESTO messaggio, per trovare se esiste un punto di non ritorno oltre
# il quale la plasticita' residua non basta piu' a compensare
...
tight_layout()
savefig('dialogo_spiking_lesione_completa.png', dpi=150)
print("\nGrafico salvato in dialogo_spiking_lesione_completa.png")
...
legend(fontsize=9)
tight_layout()
savefig('dialogo_spiking_lesione_completa_traiettoria.png', dpi=150)
print("\nGrafico traiettoria salvato in dialogo_spiking_lesione_completa_traiettoria.png")
