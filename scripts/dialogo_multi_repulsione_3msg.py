...
def run_episode(W_AB, W_BA, messaggio, rng, train, allena_BA=True):
    ...
    for turn, listener in enumerate(SCHEDULE):
        ...
        if train and listener == 'B':
            explore_pos = campiona_esplorazione_repulsiva(rng, W_AB, messaggio)
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    plt.savefig('dialogo_multi_repulsione_3msg.png', dpi=150)
    print("\nGrafico salvato in dialogo_multi_repulsione_3msg.png")
