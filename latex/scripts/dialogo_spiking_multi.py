...
title(f'Raster completo: {N_RIPETIZIONI_TOT} ripetizioni round-robin, messaggi x={MESSAGGI}')
...
tight_layout()
savefig('dialogo_spiking_multi.png', dpi=150)
print("\nGrafico salvato in dialogo_spiking_multi.png")
