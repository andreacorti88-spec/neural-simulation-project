"""
Classificazione a 1 neurone via STDP supervisionato (teacher signal).
6 input (Gruppo A=0,1,2 / Gruppo B=3,4,5) -> 1 output O, sinapsi plastiche.
Training: 10 rep, teacher forza O a sparare solo dopo il Pattern A.
Test: nessun teacher -- verifica se O risponde selettivamente ad A.
"""

from brian2 import *

# Izhikevich RS, come negli script precedenti
a = 0.02/ms
b = 0.2/ms
c = -65*mV
d = 6*mV/ms
...
# protocollo: 10 rep training (A+teacher, B senza), poi test
...
# il teacher forza lo spike di O solo durante il training di A
...
syn.w = 6*mV   # pesi iniziali uguali e bassi
